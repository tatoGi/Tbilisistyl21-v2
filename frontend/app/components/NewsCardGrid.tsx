...
export default function NewsCardGrid({ posts }: Props) {
  return (
      ...
      {posts.map((post) => (
        ...
        >
          ...
          <div className="flex flex-1 flex-col p-5">
            ...
            <div className="mt-auto flex translate-y-1 transform items-center gap-1.5 pt-5 text-[10px] font-bold uppercase tracking-[0.2em] text-yellow-300/0 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:text-yellow-300 group-hover:opacity-100">
